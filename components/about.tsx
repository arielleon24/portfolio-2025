...
import { Code, Database, GitBranch, Wrench, BookOpen, Lightbulb } from "lucide-react"
...
export default function About() {
  ...
  const skills = [
    ...
    },
    {
      ...
      description:
        "Designing and integrating scalable backend systems and APIs using Node.js, Express, and SQL for seamless data flow and performance.",
      color: "from-emerald-500 to-cyan-500",
    },
    {
      ...
      description:
        "Writing and maintaining end-to-end and unit tests with Cypress and Jest, while also providing thorough code reviews to ensure clean, high-quality development.",
      color: "from-emerald-500 to-cyan-500",
    },
    {
      ...
      description:
        "Using GitHub, and Agile workflows to collaborate efficiently, manage codebases, and streamline development.",
      color: "from-emerald-500 to-cyan-500",
    },
    {
      ...
      description:
        "Actively expanding my skill set through Udemy courses, ZTM courses, and online resources to stay current with the latest technologies and best practices.",
      color: "from-emerald-500 to-cyan-500",
    },
    {
      ...
      description:
        "Breaking down complex challenges and building elegant, scalable solutions with a curious and analytical mindset.",
      color: "from-emerald-500 to-cyan-500",
    },
  ]
  ...
  const aboutMe = `I'm a Full Stack Developer with 3+ years of experience building responsive, scalable web applications using React, TypeScript, JavaScript, Node.js, and SQL. I thrive in Agile teams, enjoy solving complex problems, and value clean, maintainable code.
                    ...
                    Fluent in English, French, and Spanish, I enjoy learning new technologies and am currently continuing to grow my skill set through multiple online resources. 
          ...
          {skills.map((skill, index) => (
            <motion.div
              ...
              className={`col-span-1 rounded-3xl bg-slate-800/50 p-6 backdrop-blur transition-transform duration-300 hover:-translate-y-1 ${
                // Apply special styling for the last two skills on tablet and desktop
                index >= skills.length - 2 ? "md:col-span-1 lg:col-span-2" : ""
              }`}
            >
              <div
